        ...
        <div className="pt-20">
          <div className="min-h-screen w-full bg-white px-5 py-8">
            <div className="max-w-3xl mx-auto px-5 py-8 space-y-12 pb-28 bg-sky-100 rounded-2xl">
              {/* Breadcrumb */}
              <div
                className={`flex flex-col sm:flex-row justify-between items-start gap-4 mb-6 transition-all duration-600 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                  }`}
              >
              ...
              <div className="grid gap-10 sm:grid-cols-2">
                {/* Gambar */}
                <div
                  className={`relative w-full rounded-2xl overflow-hidden shadow-lg transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                    }`}
                >
                ...
                {/* Informasi Produk */}
                <div
                  className={`flex flex-col justify-between transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                    }`}
                >
              ...
              {/* Cerita */}
              <section className="mt-10 bg-amber-50 p-6 rounded-xl border-l-4 border-amber-400">
