      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-6 text-sm font-medium text-gray-800">
          ...
          <div className="relative">
            ...
            {isDemografiOpen && (
              <ul className="absolute left-0 mt-2 bg-white rounded-xl shadow-md py-2 w-44 z-50 border">
                ...
                <li><Link href="/demografi/jeniskelamin" className="block px-4 py-2 hover:bg-gray-100">Jenis Kelamin</Link></li>
                ...
                <li><Link href="/demografi/umur" className="block px-4 py-2 hover:bg-gray-100">Umur</Link></li>
              </ul>
            )}
          </div>

          <Link href="/" className="hover:text-teal-600 transition">IDM</Link>
          ...
          <div className="relative">
            ...
            {isPotensiOpen && (
              <ul className="absolute left-0 mt-2 bg-white rounded-xl shadow-md py-2 w-44 z-50 border">
                <li><Link href="/potensi/lapak" className="block px-4 py-2 hover:bg-gray-100">Lapak Desa</Link></li>
                <li><Link href="/potensi/potensi-desa" className="block px-4 py-2 font-semibold text-teal-600 hover:bg-gray-100">Potensi Desa</Link></li>
              </ul>
            )}
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden px-4 pb-4">
          <ul className="space-y-2 text-sm font-medium text-gray-800 mt-2">
            ...
            <li><Link href="/">IDM</Link></li>
            <li><Link href="/">Laporan APDES</Link></li>

            {/* Mobile Dropdown Potensi */}
            <li>
              <button
